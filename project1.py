...
def myQuickSort(A, i, j): 
   ...
   if i < j:
   	partitioned_index = partitioning_function(A, i, j)
   	myQuickSort(A, i, partitioned_index -1)
   	myQuickSort(A, partitioned_index + 1, j)
...
def testingSuite(alg):
    ...
    measureTime(sortedFlag = True, numTrials = 10)
    measureTime(sortedFlag = False, numTrials = 10)
